...
class UI {
  ...
  static getWeather(searchTerm) {
    ...
    fetch(api)
      ...
      .catch(() => {
        UI.showAlert(
          'We can read your input. Maybe your spell wrong',
          'danger'
        );
      });
  }
  ...
  static displayWeather(data) {
    ...
    switch (data.weather[0].main) {
      case 'Clear':
        ...
        picture.style.backgroundImage = 'url("background/clear.jpg")';
        picture.style.backgroundSize = 'cover';
        break;

      case 'Clouds':
        UI.showAlert("It's cloudy day", 'light');
        picture.style.backgroundImage = 'url("background/cloud.jpg")';
        picture.style.backgroundSize = 'cover';
      ...
      case 'Mist':
        ...
        picture.style.backgroundImage = 'url("background/rain.jpg")';
        picture.style.backgroundSize = 'cover';
        document.body.style.color = 'white';
        //document.querySelector('.location').style.color ='black';
      ...
      case 'Thunderstorm':
        UI.showAlert("It's terrible day", 'dark');
        picture.style.backgroundImage = 'url("background/thunder.jpg")';
        picture.style.backgroundSize = 'cover';
        break;

      case 'Snow':
        UI.showAlert("It's snow day", 'light');
        picture.style.backgroundImage = 'url("background/snow.jpg")';
        picture.style.backgroundSize = 'cover';
        break;

      default:
        picture.style.backgroundImage = 'url("background/default.jpg")';
        picture.style.backgroundSize = 'cover';
        break;
    }
